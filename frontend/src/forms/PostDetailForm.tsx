...
export const PostDetailForm = (props: PostDetailFormProps) => {
    ...
    const fileType = getExtension(props.content);
        ...
        if (["jpg", "jpeg", "png", "gif", "webp"].includes(fileType)) {
            return (
                <div className="flex justify-center bg-[#151718] p-4 rounded-xl border border-white/10">
                    <img src={props.content} alt="Content" className="max-w-full rounded-lg shadow-lg" />
                </div>
            );
        }
        return (
            <div
                className="flex flex-col items-center justify-center p-12 bg-white/5
    ...
    return (
        <div className="relative min-h-screen h-auto w-full pt-16 pb-20 !overflow-visible grid-pattern">
            <div
                className={`mx-auto w-[90%] ${fileType === "md" || fileType === "txt" ? "lg:w-[90%]" : "lg:w-[60%]"} 
            ...
            >
                <div className="flex-1 min-w-0 w-full">
                    ...
                    {props.id && props.type && (
                        <CommentList postId={props.id} postAuthorId={props.authorId} onModel={props.type} />
                    )}
                </div>
